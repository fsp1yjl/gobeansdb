...
type ServerConfig struct {
	...
	DataHTTPListen    string   `yaml:"data_http_listen,omitempty"`
	Port              int      `yaml:",omitempty"`
	WebPort           int      `yaml:",omitempty"`
	DataHTTPPort      int      `yaml:"data_http_port,omitempty"`
	DataHTTPAuthToken string   `yaml:"data_http_auth_token,omitempty"`
	DataHTTPAccessLog string   `yaml:"data_http_access_log,omitempty"`
